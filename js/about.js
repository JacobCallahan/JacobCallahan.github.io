...
var bioText = "<p>Jacob has always been fascinated by the magic of computers and internet technologies. However, it wasn’t until his senior year of High School, when he took his first true programming course that he really fell in love with creating software and developing websites. Visual Basic, social media sites, and even graphing calculators; everything became an opportunity to expand his skillset and technical reach. After enlisting in the Air Force, he discovered his other talent: identifying inefficient processes and tasks in desperate need for automation. He then combined the two talents to create tools and products for his colleagues to use, resulting in increased productivity and decreased error rates.</p>\
            ...
            <p>When not referring to himself in the third person or learning a new technology, he enjoys spending time with his beautiful wife, dog and hedgehog! His other hobbies include: playing bass, progressive metal, and ultimate Frisbee. He currently works at Red Hat as a Quality Engineer for Satellite 6. Please feel free to check out a few of his works or contact him above</p>"
var skillArray = [];
...
skillArray.push({level: "9", skill: "Python"});
